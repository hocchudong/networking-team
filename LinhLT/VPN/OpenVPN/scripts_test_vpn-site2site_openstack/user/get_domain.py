...
#
# How to use?
# python getdomain.py --token $keystone_token --auth_url "http://172.16.69.53:5000/v3"
...
try:
    ...
    auth_response = requests.get(args.auth_url + '/domains', headers=headers, verify=args.verify);
    if auth_response.status_code == 200:
        token = auth_response.json()
        print (token['domains'][0]['id'])
